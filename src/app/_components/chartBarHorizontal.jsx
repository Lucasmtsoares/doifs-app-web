...
const chartConfig = {
    ...
    'label_total': {
        // Esta variável deve ser branca no seu tema escuro, garantindo contraste. var(--background)
        color: "var(--background)", 
    },
};

export function ChartBarLabelCustom() {
  const totalAtos = chartData.reduce((sum, item) => sum + item.total_acts, 0);
        ...
        <CardContent>
          ...
          >
            ...
            >
              ...
              <YAxis dataKey="director" type="category" tickLine={false} tickMargin={10} axisLine={false} hide />
